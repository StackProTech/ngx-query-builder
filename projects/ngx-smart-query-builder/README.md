# SmartQueryBuilder
A modernized Angular 4+ query builder based on jQuery QueryBuilder. Support for heavy customization with Angular components and provides a flexible way to handle custom data types along with search for columns availability.

# Getting Started

## Install

`npm install @stackpro/ngx-smart-query-builder`

## Credits
Special credits to the author of Angular2-Query-Builder [Zebzhao](https://github.com/zebzhao/Angular-QueryBuilder) and the [ng-select version 7.4.0](https://www.npmjs.com/package/@ng-select/ng-select/v/7.4.0) library which is used for searching implementation.
...
##### `app.module.ts`
```javascript
import { SmartQueryBuilderModule } from "ngx-smart-query-builder";
import { AppComponent } from "./app.component"

@NgModule(imports: [
  ...,
  SmartQueryBuilderModule,
...
##### `app.component.ts`
```javascript
import { QueryBuilderConfig } from 'ngx-smart-query-builder';
